...
function sanitize_file_name( $filename ) {
	...
	$filename .= '.' . $extension;
	/** This filter is documented in libs/formatting.php */
	return apply_filters('sanitize_file_name', $filename, $filename_raw);
}
...
function wp_trim_excerpt( $text = '' ) {
	...
	if ( '' == $text ) {
		...
		/** This filter is documented in libs/post-template.php */
...
function wp_staticize_emoji_for_email( $mail ) {
	...
	/** This filter is documented in libs/pluggable.php */
 ...
 *
 * @since 1.2.0
 * @since 4.4.0 Moved to libs/formatting.php from wp-admin/includes/misc.php and added $length param.
 *
