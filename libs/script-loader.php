...
function wp_default_scripts( &$scripts ) {
	...
	$scripts->default_dirs = array('/wp-admin/js/', '/libs/js/');
	...
	$scripts->add( 'heartbeat', "/libs/js/heartbeat$suffix.js", array('jquery'), false, 1 );
	...
	$scripts->add( 'jquery-core', '/libs/js/jquery/jquery.js', array(), '1.11.3' );
	$scripts->add( 'jquery-migrate', "/libs/js/jquery/jquery-migrate$suffix.js", array(), '1.2.1' );
	...
	$scripts->add( 'jquery-ui-autocomplete', "/libs/js/jquery/ui/autocomplete$dev_suffix.js", array('jquery-ui-menu'), '1.11.4', 1 );
	...
	$scripts->add( 'jquery-form', "/libs/js/jquery/jquery.form$suffix.js", array('jquery'), '3.37.0', 1 );
	...
	$scripts->add( 'masonry', "/libs/js/masonry.min.js", array(), '3.1.2', 1 );
	$scripts->add( 'jquery-masonry', "/libs/js/jquery/jquery.masonry$dev_suffix.js", array( 'jquery', 'masonry' ), '3.1.2', 1 );
	...
	$scripts->add( 'plupload', '/libs/js/plupload/plupload.full.min.js', array(), '2.1.8' );
	// Back compat handles:
	...
	$scripts->add( 'swfupload-swfobject', '/libs/js/swfupload/plugins/swfupload.swfobject.js', array('swfupload', 'swfobject'), '2201a');
	$scripts->add( 'swfupload-queue', '/libs/js/swfupload/plugins/swfupload.queue.js', array('swfupload'), '2201');
	$scripts->add( 'swfupload-speed', '/libs/js/swfupload/plugins/swfupload.speed.js', array('swfupload'), '2201');
	...
	$scripts->add( 'underscore', "/libs/js/underscore$dev_suffix.js", array(), '1.6.0', 1 );
	$scripts->add( 'backbone', "/libs/js/backbone$dev_suffix.js", array( 'underscore','jquery' ), '1.1.2', 1 );
	...
	$scripts->add( 'mediaelement', "/libs/js/mediaelement/mediaelement-and-player.min.js", array('jquery'), '2.18.1', 1 );
	...
	$scripts->add( 'wp-mediaelement', "/libs/js/mediaelement/wp-mediaelement.js", array('mediaelement'), false, 1 );
	$mejs_settings = array(
	...
	$scripts->add( 'froogaloop',  "/libs/js/mediaelement/froogaloop.min.js", array(), '2.0' );
	$scripts->add( 'wp-playlist', "/libs/js/mediaelement/wp-playlist.js", array( 'wp-util', 'backbone', 'mediaelement' ), false, 1 );
	...
	$scripts->add( 'wplink', "/libs/js/wplink$suffix.js", array( 'jquery' ), false, 1 );
	...
	$scripts->add( 'customize-preview',  "/libs/js/customize-preview$suffix.js",  array( 'customize-base' ), false, 1 );
	...
	$scripts->add( 'customize-preview-widgets', "/libs/js/customize-preview-widgets$suffix.js", array( 'jquery', 'wp-util', 'customize-preview' ), false, 1 );
	...
	$scripts->add( 'customize-preview-nav-menus', "/libs/js/customize-preview-nav-menus$suffix.js", array( 'jquery', 'wp-util', 'customize-preview' ), false, 1 );
	...
	$scripts->add( 'media-views',  "/libs/js/media-views$suffix.js",  array( 'utils', 'media-models', 'wp-plupload', 'jquery-ui-sortable', 'wp-mediaelement' ), false, 1 );
...
function wp_default_styles( &$styles ) {
	...
	$styles->default_dirs = array('/wp-admin/', '/libs/css/');
	...
	// Includes CSS
	$styles->add( 'admin-bar',            "/libs/css/admin-bar$suffix.css", array( 'open-sans', 'dashicons' ) );
	...
	$styles->add( 'customize-preview',    "/libs/css/customize-preview$suffix.css" );
	...
	$styles->add( 'mediaelement',        "/libs/js/mediaelement/mediaelementplayer.min.css", array(), '2.18.1' );
	$styles->add( 'wp-mediaelement',     "/libs/js/mediaelement/wp-mediaelement.css", array( 'mediaelement' ) );
