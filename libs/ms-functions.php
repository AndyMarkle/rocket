...
function wpmu_validate_user_signup($user_name, $user_email) {
	...
	/** This filter is documented in libs/user.php */
 ...
 * which is defined in libs/functions.php in
...
function wp_maybe_update_network_user_counts() {
	...
	/** This filter is documented in libs/ms-functions.php */
...
function get_subdirectory_reserved_names() {
	 ...
	 *
	 * @since 3.0.0
	 * @since 4.4.0 'wp-admin', 'wp-content', 'libs', 'wp-json', and 'embed' were added
