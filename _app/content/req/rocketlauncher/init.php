...
register_uninstall_hook( __FILE__, array( '/admin/_Setup', 'on_uninstall' ) );
register_activation_hook( __FILE__, array( 'RocketLauncher_Setup','on_activate' ) );

add_action( 'plugins_loaded', array( 'RocketLauncher', 'init' ) );
...
EOF;
	...
	public function admin_menu( $parent_file )
	{
		...
		# >>>> Sub menu items
		    ...
		    // Update Core
			remove_submenu_page( 'update_core.php');
