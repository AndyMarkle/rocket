...
$panel = $this->options->createAdminPanel(array(
  ...
  'name'  => __('Rocket', 'material-wp'),
  'title' => __('Rocket', 'material-wp'),
  'desc'  => __('Please use the following settings below to make the Administrative Panel Yours', 'material-wp'),
  'icon'  => 'dashicons-art',
