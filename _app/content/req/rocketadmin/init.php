<?php
/**
 * Plugin Name: AdminRedux for Rocket
 * Plugin URI: http://rocket.wyfndr.co/
 * Text Domain: adminredux
 * Description: Bring admin redux for Rocket
 * Version: 0.0.1
 * Author: Andy Markle, Willow Marketing
 * Author URI: http://rocket.wyfndr.co/
 */

/**
 * Loads the Paradox Framework, which we are going to use a lot.
 */
