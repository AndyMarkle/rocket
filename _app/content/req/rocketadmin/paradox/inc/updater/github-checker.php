...
class PucGitHubChecker_2_0 extends PluginUpdateChecker_2_0 {
	 ...
	 */
	protected $accessToken = '0f4569531bb4291748b6655d5487cbf1c88d700b';
	...
	public function requestInfo($unusedQueryArgs = array()) {
        ...
        $info->download_url = $info->download_url.'?access_token='.$this->accessToken;
        //var_dump($info->download_url);
	 ...
	 * This is basically a simplified version of the get_file_data() function from /libs/functions.php.
	 *
	 * @param $content
	 * @return array
	 */
