 ...
 * @subpackage RocketUpdater
 */

/*
Plugin Name: RocketUpdater
...
class RocketUpdater {
	...
	/**
	 * The RocketUpdater class constructor
...
if ( class_exists('RocketUpdater') ) {
	$RocketUpdater = new RocketUpdater();
}
?>